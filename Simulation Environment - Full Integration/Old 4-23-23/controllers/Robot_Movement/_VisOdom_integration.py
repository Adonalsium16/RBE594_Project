...
class VisualOdom():
    ...
    def solvePose(self,q1,q2,currentPose):
        ...
        print(np.shape(new_pose))
        
        eul = self._rot_2_eul(new_pose[0:3, 0:3])
        
        vel = self.calcVel(new_pose[0:2][1],currentPose[0:2][1])
        
        return new_pose, vel, eul
